...
//    }
    ...
    public Response<?> getDiagnose(@RequestHeader("authorization") String authorization, @PathVariable("id") long id) {
...
//    }
    ...
    @DeleteMapping("/{id}")
    @ApiOperation(value = "진단 내역 삭제", notes = "해당 id의 진단 내역을 삭제한다.")
    public Response<?> deleteDiagnose(@RequestHeader("authorization") String authorization, @PathVariable("id") long id) {
