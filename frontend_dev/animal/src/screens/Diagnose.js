      ...
      {loading ? (
        ...
        <div id="diagnose-result">
          ...
          <div style={{ width: "550px", marginBottom: "30px" }}>
            농피증은 피부가 포도상구균 등과 같은 세균에 감염돼 나타난다.
            ▲영양부족 ▲미흡한 털관리 ▲과도한 목욕 ▲잘못된 샴푸사용 등이
            원인이다. 피부가 약하고 면역력이 떨어지는 노령견이나 어린강아지에게
            더욱 생기기 쉽다. 농피증은 얼굴주위, 겨드랑이, 등에 많이 발생하며
            감염정도나 농의 깊이에 따라 증상이 다르다. 일반적으로 ▲발진 ▲구진
            ▲농포 ▲각질 ▲딱지 ▲피부발적 ▲탈모 등이 나타나고 ▲심한 가려움이
            동반되는 경우가 많다. 가려움이 심하면 강아지가 해당부위를 자꾸
            긁거나 핥아 질환이 더 악화되고 이차감염으로 진행될 수 있어 빨리
            치료하는 것이 좋다.
          </div>
          <StyledBtn
            id="btn10"
